...
export const validateOTP = async (req, res) => {
    try {
        ...
        // let user = await prisma.houseOwner.findFirst({
        //   where: {
        //     accessToken: token,
        //   },
        // });
        ...
        const { accessToken, refreshToken } = await generateJWTToken(userDetails?.created_by?.email, userDetails?.created_by?.fullname);

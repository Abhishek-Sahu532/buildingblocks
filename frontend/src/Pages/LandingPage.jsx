                ...
                <div className="flex flex-row justify-center w-full p-6 bg-white-A700 rounded-[16px]">
                  ...
                  >
                    <TabList className="flex flex-row justify-between w-full gap-[155px] p-[9px]">
                      <Tab className="mt-[5px] ml-[62px] text-white-A700 text-lg font-bold">
                        Buy
                      </Tab>
                      <Tab className="text-gray-900 text-lg font-bold">
                        Sell
                      </Tab>
                      <Tab className="mr-[57px] text-gray-900 text-lg font-bold">
                        Rent
                      </Tab>
                    </TabList>
                    {[...Array(3)].map((_, index) => (
              ...
              <div className="flex flex-col items-center justify-start w-full gap-[17px]">
                ...
                <div className="flex flex-row justify-start w-full">
                  <Button
                    size="xs"
                    shape="square"
                    className="text-gray-900 font-bold min-w-[159px]"
                  >
                    Resident Property
                  </Button>
                  <Button
                    size="xs"
                    shape="square"
                    className="ml-[143px] text-gray-400 font-bold min-w-[186px]"
                  >
                    Commercial Property
                  </Button>
                  <Button
                    size="xs"
                    shape="square"
                    className="ml-[116px] text-gray-400 font-bold min-w-[164px]"
                  >
                    Industrial Property
                  </Button>
                  <Button
                    size="xs"
                    shape="square"
                    className="ml-[137px] text-gray-400 font-bold min-w-[180px]"
                  >
          ...
          <div className="flex flex-col items-center justify-start w-full gap-[150px] max-w-[1200px]">
            <div className="flex flex-row justify-between items-center w-full">
              <div className="flex flex-col items-start justify-start w-[47%] gap-[58px]">
                ...
                <Button className="font-semibold min-w-[138px]">
                  Get Started
                </Button>
              </div>
            ...
            <div className="flex flex-row justify-between items-center w-full">
              ...
              <div className="flex flex-col items-start justify-start w-[44%] gap-[60px]">
                  ...
                  <div className="flex flex-col items-center justify-start w-full gap-3">
                    ...
                    <div className="flex flex-row justify-start items-center w-full gap-3.5">
                      ...
                      <Heading
                        size="md"
                        as="h5"
                        className="mt-[5px] !font-semibold"
                      >
                ...
                <Button className="font-semibold min-w-[134px]">
                  Learn more
                </Button>
              </div>
            </div>

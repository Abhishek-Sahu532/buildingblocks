        ...
        <div className="flex flex-col items-center justify-start w-full gap-[50px] md:gap-[75px] lg:gap-[100px]">
          <div className="flex flex-row justify-center w-full">
            <div className="flex flex-col items-center justify-start w-full gap-[38px] max-w-[1200px] px-4 md:px-6 lg:px-8">
              <div className="flex flex-col items-center justify-start w-full gap-4">
                <h1 className="tracking-[-1.08px] text-center text-2xl md:text-3xl lg:text-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-1 md:gap-8 lg:gap-12 p-2 md:p-8 lg:p-10 bg-gray-50 w-full">
            {addtionalDetails.map((link, index) => (
              <div key={index} className="flex w-full md:w-1/2 lg:w-1/5 gap-4 md:gap-6 p-4">
                <Button color="white_A700" size="3xl" shape="circle" className="w-[60px] shrink-0">
          ...
          <div className="flex flex-col items-start justify-start w-full px-4 lg:px-[120px]">
          ...
          <div className="flex flex-col items-center justify-start w-full px-4 lg:px-14 py-8 lg:py-[120px]">
            <div className="flex flex-col items-center justify-start w-full gap-8 max-w-[1200px]">
              ...
              <div className="flex flex-col items-center justify-start w-full gap-8 p-6 lg:p-10 bg-gray-400_01 rounded-lg">
                ...
                <div className="flex flex-col md:flex-row justify-center w-full lg:w-[54%] gap-4">
                  <Input
                    type="email"
                    name="email"
                    placeholder="Enter your Email"
                    className="w-full md:w-[78%] py-2 px-4 rounded-lg"
                  />
                  <Button className="w-full md:w-auto min-w-[126px] bg-blue-500 text-white">Subscribe</Button>
                </div>
              </div>
            </div>
          </div>

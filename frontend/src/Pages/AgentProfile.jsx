              ...
              <div className="flex flex-col items-center justify-start w-full mt-[-46px] gap-[58px]">
                    ...
                    <div className="flex flex-row justify-start items-center w-[83%] gap-8">
                      <div className="flex flex-col items-start justify-start w-[49%] gap-1.5">
                        ...
                        <div className="flex flex-row justify-start items-center gap-3.5 py-0.5">
                          ...
                          />
                          <Typography as="h2">4.5 review</Typography>
                        </div>
                      </div>
                      <div className="flex flex-col items-center justify-start w-[49%] gap-2">
                        ...
                        <div className="flex flex-row justify-start items-center w-full gap-3 py-0.5">
                          <img
                            ...
                            className="h-6 w-6"
                          />
                          <Typography size="md" as="h4" className="mt-0.5">
                            bruno@relasto .com
                          </Typography>
                        </div>
                      </div>
                    </div>
                    <Button className="font-semibold min-w-[112px]">
                      Contact
                    </Button>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-start w-full gap-12 max-w-[1200px]">
                  <div className="flex flex-col lg:flex-row justify-start w-full gap-3">
                    <Button
                      size="lg"
                      className="font-semibold min-w-full lg:min-w-[291px] mb-3 lg:mb-0"
                    >
                      For rent
                    </Button>
                    <Button
          ...
          <div className="flex flex-col items-center justify-start w-full lg:w-[47%] gap-6 md:gap-[57px]">
            <div className="flex flex-col items-center justify-start w-full gap-6">
              <div className="flex flex-row justify-center items-center w-full gap-4">
                ...
                <div className="flex flex-col items-start justify-start w-3/5 gap-1.5">
                  <Typography
                    size="xl"
                    as="h2"
                    className="text-xl tracking-[-0.48px]"
                  >
                    Bruno Fernandes
                  </Typography>
                  ...
                  <div className="flex flex-row justify-start items-center gap-3 py-0.5">
                    <img
                      ...
                      className="h-6 w-6"
                    />
                    <Typography size="md" as="h5" className="mt-0.5">
                      bruno@relasto .com
                    </Typography>
                  </div>
                </div>
              ...
              <Typography as="p" className="!text-gray-600_02">
                ...
                videos, usually on your homepage.
                <br />
                Adding sliders to your site is no longer difficult. You don’t
                have to know coding anymore. Just use a slider widget and it
                will automatically insert the slider on your web page.
                <br />
          ...
          <div className="flex flex-col items-center justify-start w-full lg:w-[47%] gap-6">
            <div className="flex flex-col items-start justify-center w-full gap-1.5">
              <Typography
                size="lg"
                as="h2"
                className="mt-0.5 text-lg tracking-[-0.40px]"
              >
                Experiences
              </Typography>
              <Typography size="md" as="h3" className="text-gray-600_02">
                15+ years experience
              </Typography>
            </div>
            <div className="flex flex-col items-start justify-center w-full gap-1.5">
              ...
              <Typography size="md" as="h5" className="text-gray-600_02">
                Private House, Villa, Townhouse, Apartment
              </Typography>
            </div>
            <div className="flex flex-col items-start justify-center w-full gap-2">
              <Typography size="lg" as="h6" className="tracking-[-0.40px]">
                Area
              </Typography>
              <Typography size="md" as="h6" className="mb-px">
                California, San Jose, Miami
              </Typography>
            </div>
            <div className="flex flex-col items-start justify-center w-full gap-2">
              <Typography size="lg" as="h5" className="tracking-[-0.40px]">
                Address
              </Typography>
              <Typography size="md" as="h6" className="mb-px !text-gray-600_02">
            ...
            <div className="flex flex-row justify-between w-full gap-[60px]">
              <div className="flex flex-col items-start justify-center gap-[7px]">
                ...
                <Typography
                  size="md"
                  as="h6"
                  className="mb-0.5 text-gray-600_02"
                >
                  BF-0535
                </Typography>
              </div>
              <div className="flex flex-col items-start justify-center gap-[7px]">
                ...
                >
                  <Typography
                    size="md"
                    as="h6"
                    className="underline text-gray-600_02"
                  >
                    www.abc.com
                  </Typography>
                </a>
          ...
          <div className="flex flex-col items-center justify-start w-full gap-[22px]">
            <div className="flex flex-row justify-between items-center w-full px-[42px]">
              <Typography
                size="2xl"
                as="h2"
                className="text-2xl tracking-[-0.56px]"
              >
                Clients Review
              </Typography>
            </div>
            ...
            <div className="flex flex-col w-full gap-[25px]">
              <div className="flex flex-col items-center justify-center w-full gap-10 p-[29px] border-blue_gray-100_01 border border-solid bg-white-A700 rounded-[20px]">
                <Typography
                  size="xl"
                  as="h2"
                  className="text-xl mt-[9px] text-gray-600_02 font-semibold leading-[165%]"
                >
                  ...
                  <div className="flex flex-row justify-start w-full gap-[50px]">
                    <div className="flex flex-row justify-start items-center w-[23%] gap-2.5">
                      ...
                      <Typography
                        size="lg"
                        as="h3"
                        className="text-lg text-gray-600_02 tracking-[-0.40px]"
                      >
                        4.5 review
                      </Typography>
                    </div>
                  ...
                  <div className="flex flex-row justify-start items-center w-full gap-4">
                    ...
                    <div className="flex flex-col items-start justify-center w-[92%] gap-[5px]">
                      <Typography
                        size="2xl"
                        as="h5"
                        className="text-2xl mt-0.5 tracking-[-0.56px]"
                      >
                        Taylor Wilson
                      </Typography>
